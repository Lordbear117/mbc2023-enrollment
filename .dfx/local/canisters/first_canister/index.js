...
import { idlFactory } from './first_canister.did.js';
export { idlFactory } from './first_canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.FIRST_CANISTER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./first_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the first_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./first_canister.did.js")._SERVICE>}
 */
export const first_canister = createActor(canisterId);
